...
- It's a concept where we create a single shell page or master page and load the webpages inside that master page instead of loading 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMwMDI2ODM5NCwyMjYyNjMzMjAsLTU0Mj
